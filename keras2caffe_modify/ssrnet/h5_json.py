...
WEIGHTS_PATH = '/home/lc/keras2caffe/ssrnet/ssrnet_3_3_3_64_1.0_0.75.h5'
WEIGHTS_PATH_NO_TOP = '/home/lc/keras2caffe/ssrnet/ssrnet_3_3_3_64_1.0_1.0.h5'
...
def create_model(s1=3,s2=3,s3=3,lambda_local=1.0,lambda_d=0.75, weights='imdb', include_top=True):
    model=ssrnet(s1,s2,s3,lambda_local,lambda_d,weights, include_top)
    json_string=model.to_json()
    with open('ssrnet.json','w') as json_file:
        json_file.write(json_string)
    model.save_model('ssrnet.h5')
