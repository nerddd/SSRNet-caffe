...
def main():
    ...
    ref_img = cv2.imread(mypath+'/009055_01M54.JPG')
    ...
    print('img:',np.array(out_imgs))
    print('age:',np.array(out_ages))
    print('gender:',np.array(out_genders))
