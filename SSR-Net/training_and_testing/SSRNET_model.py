...
#    def create_model(self):
    def __call__(self):
        ...
        s_layer4_mix = Dense(units=self.stage_num[0], activation="relu",name='dense_1')(s_layer4_mix)
        ...
        x_layer4_mix = Dense(units=self.stage_num[0], activation="relu",name='dense_2')(x_layer4_mix)
        ...
        feat_a_s1 = Dense(2*self.stage_num[0],activation='relu',name='dense_3')(feat_a_s1)
        pred_a_s1 = Dense(units=self.stage_num[0], activation="relu",name='pred_stage1')(feat_a_s1)
        ...
        s_layer2_mix = Dense(self.stage_num[1],activation='relu',name='dense_4')(s_layer2_mix)
        ...
        x_layer2_mix = Dense(self.stage_num[1],activation='relu',name='dense_5')(x_layer2_mix)
        ...
        feat_a_s2 = Dense(2*self.stage_num[1],activation='relu',name='dense_6')(feat_a_s2)
        pred_a_s2 = Dense(units=self.stage_num[1], activation="relu",name='pred_stage2')(feat_a_s2)
        ...
        s_layer1_mix = Dense(self.stage_num[2],activation='relu',name='dense_7')(s_layer1_mix)
        ...
        x_layer1_mix = Dense(self.stage_num[2],activation='relu',name='dense_8')(x_layer1_mix)
        ...
        feat_a_s3 = Dense(2*self.stage_num[2],activation='relu',name='dense_9')(feat_a_s3)
        pred_a_s3 = Dense(units=self.stage_num[2], activation="relu",name='pred_stage3')(feat_a_s3)
